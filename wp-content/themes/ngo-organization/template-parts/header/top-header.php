...
<div class="top-header py-2 <?php if( is_user_logged_in() && !isset( $wp_customize ) ){ echo "login-user";} ?>" data-sticky="<?php echo esc_attr($ngo_organization_data_sticky); ?>">
  <div class="container">
    <div class="row">
        ...
        <div class="topbar py-3">
            <div class="row">
              <div class="col-lg-8 col-md-6 text-lg-left">
                ...
                <span class="mr-2"><i class="fas fa-phone mr-2"></i><?php echo esc_html( get_theme_mod('ngo_organization_phone_number','')); ?></span>
              <?php } ?>
              <?php if( get_theme_mod( 'ngo_organization_email_address' ) != '') { ?>
                <span class="mr-2"><i class="far fa-envelope mr-2"></i><?php echo esc_html( get_theme_mod('ngo_organization_email_address','')); ?></span>
              <?php } ?>
              </div>
              ...
              <?php if( get_theme_mod( 'ngo_organization_login_button_link' ) != '' || get_theme_mod( 'ngo_organization_login_button' ) != '') { ?>
                <a href="<?php echo esc_url( get_theme_mod( 'ngo_organization_login_button_link','' ) ); ?>" class="login-btn"><i class="fas fa-lock mr-2"></i><?php echo esc_html( get_theme_mod( 'ngo_organization_login_button','' ) ); ?></a>
              <?php } ?>
              </div>
          </div>
        </div>
