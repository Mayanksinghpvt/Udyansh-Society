      ...
      <span class="media-links">
        <?php                  
           ...
           <?php if( get_theme_mod( 'ngo_organization_facebook_url' ) != '') { ?>
              <a <?php if($ngo_organization_facebook_new_tab != false ) { ?>target="_blank" <?php } ?>href="<?php echo esc_url( get_theme_mod( 'ngo_organization_facebook_url','' ) ); ?>"><i class="fab fa-facebook-f mr-2"></i></a>
            <?php } ?>
          <?php if( get_theme_mod( 'ngo_organization_twitter_url' ) != '') { ?>
            <a <?php if($ngo_organization_twitter_new_tab != false ) { ?>target="_blank" <?php } ?>href="<?php echo esc_url( get_theme_mod( 'ngo_organization_twitter_url','' ) ); ?>"><i class="fab fa-twitter mr-2"></i></a>
          <?php } ?>
          <?php if( get_theme_mod( 'ngo_organization_instagram_url' ) != '') { ?>
            <a <?php if($ngo_organization_instagram_new_tab != false ) { ?>target="_blank" <?php } ?>href="<?php echo esc_url( get_theme_mod( 'ngo_organization_instagram_url','' ) ); ?>"><i class="fab fa-instagram mr-2"></i></a>
          <?php } ?>
          <?php if( get_theme_mod( 'ngo_organization_youtube_url' ) != '') { ?>
            <a <?php if($ngo_organization_youtube_new_tab != false ) { ?>target="_blank" <?php } ?>href="<?php echo esc_url( get_theme_mod( 'ngo_organization_youtube_url','' ) ); ?>"><i class="fab fa-youtube mr-2"></i></a>
          <?php } ?>
          <?php if( get_theme_mod( 'ngo_organization_pint_url' ) != '') { ?>
            <a <?php if($ngo_organization_pint_new_tab != false ) { ?>target="_blank" <?php } ?>href="<?php echo esc_url( get_theme_mod( 'ngo_organization_pint_url','' ) ); ?>"><i class="fab fa-pinterest mr-2"></i></a>
          <?php } ?>
        </span>
    </div>
</section>
