	...
	?>
		<div class="feature-section two-col">
			...
			<div class="col card">
				...
				<p><a href="<?php echo esc_url( NGO_ORGANIZATION_SUPPORT_THEME_URL ); ?>" class="button button-primary"><?php esc_html_e( 'Support Forum', 'ngo-organization' ); ?></a></p>
			</div>
				...
				<table>
					...
					<tbody>
						...
						<tr class="odd" scope="row">
							...
							<td class="feature feature--empty"></td>
							<td headers="comp-2" class="td-btn-2"><a class="sidebar-button single-btn" href="<?php echo esc_url(NGO_ORGANIZATION_PRO_THEME_URL);?>"><?php esc_html_e( 'Go for Premium', 'ngo-organization' ); ?></a></td>
						</tr>
					</tbody>
				</table>
			</div>
