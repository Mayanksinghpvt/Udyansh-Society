...
function ngo_organization_customize_register( $wp_customize ) {
   ...
   // Add Settings and Controls for Post Layout
	...
	$wp_customize->add_control('ngo_organization_sidebar_post_layout',array(
        'type' => 'radio',
        'label'     => __('Theme Sidebar Position', 'ngo-organization'),
	...
	$wp_customize->add_setting( 'ngo_organization_main_color_option', array(
	    'default' => '',
	    'sanitize_callback' => 'sanitize_hex_color'
  	));
  	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'ngo_organization_main_color_option', array(
	    ...
	    'settings' => 'ngo_organization_main_color_option',
  	)));

  	$wp_customize->add_setting( 'ngo_organization_secondary_color_option', array(
	    'default' => '',
	    'sanitize_callback' => 'sanitize_hex_color'
  	));
  	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'ngo_organization_secondary_color_option', array(
	    'description' => __('It will change the complete theme color 2 in one click.', 'ngo-organization'),
	    'section' => 'ngo_organization_color_option',
	    'settings' => 'ngo_organization_secondary_color_option',
  	)));
	...
	$wp_customize->add_section('ngo_organization_blog_option',array(
		...
		$wp_customize->add_setting( 'ngo_organization_remove_date', array(
			'default'           => true,
			'transport'         => 'refresh',
			'sanitize_callback' => 'ngo_organization_sanitize_checkbox',
		) );
		$wp_customize->add_control( new NGO_Organization_Toggle_Control( $wp_customize, 'ngo_organization_remove_date', array(
			'label'       => esc_html__( 'Show / Hide Date Option', 'ngo-organization' ),
			'section'     => 'ngo_organization_blog_option',
			'type'        => 'toggle',
			'settings'    => 'ngo_organization_remove_date',
		) ) );
    $wp_customize->selective_refresh->add_partial( 'ngo_organization_remove_date', array(
		'selector' => '.entry-date',
		'render_callback' => 'ngo_organization_customize_partial_ngo_organization_remove_date',
	 ));

	 $wp_customize->add_setting( 'ngo_organization_remove_author', array(
		 'default'           => true,
		 'transport'         => 'refresh',
		 'sanitize_callback' => 'ngo_organization_sanitize_checkbox',
	 ) );
	 $wp_customize->add_control( new NGO_Organization_Toggle_Control( $wp_customize, 'ngo_organization_remove_author', array(
		 'label'       => esc_html__( 'Show / Hide Author Option', 'ngo-organization' ),
		 'section'     => 'ngo_organization_blog_option',
		 'type'        => 'toggle',
		 'settings'    => 'ngo_organization_remove_author',
	 ) ) );
    $wp_customize->selective_refresh->add_partial( 'ngo_organization_remove_author', array(
		'selector' => '.entry-author',
		'render_callback' => 'ngo_organization_customize_partial_ngo_organization_remove_author',
	 ));

	 $wp_customize->add_setting( 'ngo_organization_remove_comments', array(
		 'default'           => true,
		 'transport'         => 'refresh',
		 'sanitize_callback' => 'ngo_organization_sanitize_checkbox',
	 ) );
	 $wp_customize->add_control( new NGO_Organization_Toggle_Control( $wp_customize, 'ngo_organization_remove_comments', array(
		 'label'       => esc_html__( 'Show / Hide Comment Option', 'ngo-organization' ),
		 'section'     => 'ngo_organization_blog_option',
		 'type'        => 'toggle',
		 'settings'    => 'ngo_organization_remove_comments',
	 ) ) );
    $wp_customize->selective_refresh->add_partial( 'ngo_organization_remove_comments', array(
		'selector' => '.entry-comments',
		'render_callback' => 'ngo_organization_customize_partial_ngo_organization_remove_comments',
	 ));
